...
3. [설화/전설/신화 중심 서술 원칙]: 대상 장소나 브리핑 자료에 설화/전설/신화가 포함된 경우(키워드/태그 #설화, #전설, #신화 등), 건조한 행정/지정 연혁이나 면적 수치보다 **설화 속 등장인물의 사연, 전설적 사건의 전개 및 지명 유래에 얽힌 스토리텔링 줄거리**에 최우선으로 집중하여 서술합니다.
4. [핵심 요약 구성]: 명소의 핵심 유래·설화·역사·지질 특징 중 가장 중요한 포인트만 2~3개의 깔끔한 문장으로 서술합니다.
5. [쉬운 어휘 및 숫자 정제]: 어려운 한자어나 지질학 전문 용어(예: 응회환, 절리, 화쇄류)는 일상적인 쉬운 표현으로 풀어서 설명하고, 과도한 연도/치수 나열을 지양합니다.
6. [엄격한 분량 준수]: 공백 포함 200~300자 내외로 정갈하게 작성합니다.
</factual_grounding_rules>
`;
...
- [필수] 설화나 전설이 얽힌 장소(구전문학 기록 또는 #설화 태그)인 경우, 건조한 수치나 행정 연혁 대신 **설화의 등장인물과 전설적 사건의 핵심 줄거리**에 집중하여 생생하게 서술하십시오.
