...
export const VERIFIED_LANDMARKS = {
  ...
  // 한라산 지형/명소/대피소/능선
  '개미목': [33.3850, 126.5380],
  '개미등': [33.3850, 126.5380],
  '장구목': [33.3715, 126.5312],
  '삼각봉': [33.3768, 126.5382],
  '삼각봉대피소': [33.3768, 126.5382],
  '용진굴': [33.3735, 126.5370],
  '탐라계곡': [33.4010, 126.5490],
  '탐라계곡대피소': [33.3980, 126.5460],
  '왕관릉': [33.3685, 126.5365],
  '백록담': [33.3617, 126.5332],
  '윗세오름': [33.3592, 126.4975],
  '영실기암': [33.3510, 126.4912],
  '오백나한': [33.3510, 126.4912],
  '진달래밭': [33.3680, 126.5540],
  '진달래밭대피소': [33.3680, 126.5540],
  '사라오름': [33.3725, 126.5680],
  '남벽분기점': [33.3530, 126.5320],
  '방아오름': [33.3550, 126.5120],
  '만세동산': [33.3660, 126.5050],
  '오등동 사지': [33.4606, 126.5397],
  '오등동사지': [33.4606, 126.5397],
  '죽성 새가름': [33.4606, 126.5397],
  '죽성 새장밭': [33.4606, 126.5397],
