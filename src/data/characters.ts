...
1. 핵심 팩트 중심 간결 요약: 명소의 핵심 역사, 설화, 특징 중 가장 중요한 포인트만 2~3개의 정갈한 문장으로 요약하십시오.
2. 쉬운 단어 및 최소한의 숫자: 어려운 한자어나 지질학 전문 용어는 쉬운 말로 풀어서 설명하십시오.
3. 읽기 편한 분량: 공백 포함 200~300자 내외로 출력하십시오.
</factual_grounding_rules>`
  }
};
